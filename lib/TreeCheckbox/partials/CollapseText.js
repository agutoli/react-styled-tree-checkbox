(function (global, factory) {
  ...
  exports.default = _styledComponents2.default.span(_templateObject, _default('color'), _default('width'), _default('margin-left'), _default('font-family'), _default('font-size'));
});
