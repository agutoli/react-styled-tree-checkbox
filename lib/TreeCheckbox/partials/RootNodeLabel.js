(function (global, factory) {
  ...
  exports.default = _styledComponents2.default.label(_templateObject, _default('font-size'), _default('font-weight'), _default('font-family'), _default('line-height'), _childrenLen('color'), _childrenLen('font-size'), _childrenLen('font-weight'));
});
