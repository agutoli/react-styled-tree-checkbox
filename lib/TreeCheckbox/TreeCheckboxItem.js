(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', './partials/ItemWrapper', './partials/CollapseText', './partials/ArrowCollapse', './partials/InputCheckbox', './partials/RootNodeWrapper', './partials/ChildNodeWrapper', './partials/ChildrenNodeWrapper', './renderers/rootLabelRenderer', './renderers/childLabelRenderer'], factory);
    ...
    factory(mod.exports, global.react, global.propTypes, global.ItemWrapper, global.CollapseText, global.ArrowCollapse, global.InputCheckbox, global.RootNodeWrapper, global.ChildNodeWrapper, global.ChildrenNodeWrapper, global.rootLabelRenderer, global.childLabelRenderer);
    global.TreeCheckboxItem = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _ItemWrapper, _CollapseText, _ArrowCollapse, _InputCheckbox, _RootNodeWrapper, _ChildNodeWrapper, _ChildrenNodeWrapper, _rootLabelRenderer, _childLabelRenderer) {
  'use strict';
  ...
  var TreeCheckboxItem = function (_React$PureComponent) {
    ...
    _createClass(TreeCheckboxItem, [{
          ...
          children.map(function (node) {
            return _react2.default.createElement(
              ...
              showNativeStyle ? _react2.default.createElement('input', {
                ...
                type: 'checkbox',
                value: node.value,
                onChange: _this2.onChangeChildField }) : _react2.default.createElement(_InputCheckbox2.default, {
                id: 'child-node-' + node.value,
                value: node.value,
                checked: selectedValues.has(node.value),
                onChange: _this2.onChangeChildField }),
              _this2.props.childLabelRenderer(node)
            );
          })
        );
      }
      ...
      value: function componentDidMount() {
        ...
        setTimeout(function () {
          if (_this3.props.node.checked) {
            _this3.selectAllItems(_this3.props.node);
          }
        }, 1);
      }
    }]);
